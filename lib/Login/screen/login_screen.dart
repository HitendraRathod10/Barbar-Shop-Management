...
class LoginScreen extends StatefulWidget {
  String selectedType;
  LoginScreen(this.selectedType, {super.key});
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            if (user != null) {
                              ...
                              if (snapshotData.docChanges[0].doc.get("userType") == widget.selectedType) {
                                ...
                                print(
                                    "TTTT ${snapshotData.docChanges[0].doc.get("userType")}");

                                for (var data in snapshotData.docChanges) {
                                  debugPrint(
                                      'User Name ${data.doc.get('userEmail')}');
                                  LoginProvider().addUserDetail(
                                      ...
                                      userImage: data.doc.get("userImage"),
                                      uId: data.doc.get("uid"),
                                      fcmToken: fcmToken.toString(),
                                      shopName: data.doc.get("shopName"),
                                      shopDescription:
                                          data.doc.get('shopDescription'),
